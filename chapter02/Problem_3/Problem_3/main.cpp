...
/*
 *《学习OpenCV》第二章第三题
 * 从摄像机读入视频数据，并做缩放变换，将结果存入磁盘。
 * 完成时间：22:01 3/31 星期日 2013
 */
...
int main()
{
	...
	CvVideoWriter* writer = cvCreateAVIWriter( "video_record.avi",
		CV_FOURCC( 'M', 'J', 'P', 'G' ), 10, cvGetSize(frame), 1);
	...
	{     
		...
		// 写入视频文件
		cvWriteFrame( writer, frame_pyrdown );
